...
class Mouse2:
    ...
    def __init__(self, devices: Sequence[usb_hid.Device]):
        ...
        # report[4] pan movement
        self.report = bytearray(4) #5
    ...
    def move(self, x: int = 0, y: int = 0, wheel: int = 0) -> None:#, pan: int = 0) -> None:
